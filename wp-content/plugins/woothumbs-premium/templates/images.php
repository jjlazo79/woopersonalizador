...
<?php do_action( 'iconic_woothumbs_before_all_images_wrap' ); ?>
	...
	<div class="<?php echo implode( ' ', $classes ); ?>" data-showing="<?php echo $initial_product_id; ?>" data-parentid="<?php echo $product->get_id(); ?>" data-default="<?php echo htmlentities( json_encode( $default_images ), ENT_QUOTES, 'UTF-8' ); ?>" data-slide-count="<?php echo count( $images ); ?>" data-maintain-slide-index="<?php echo $maintain_slide_index; ?>"
