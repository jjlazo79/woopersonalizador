				...
				foreach ( $images as $image ): ?>
					...
					<div class="iconic-woothumbs-thumbnails__slide <?php if ( $i == 0 ) { ?>iconic-woothumbs-thumbnails__slide--active<?php } ?>" data-index="<?php echo $i; ?>">
						...
						<div class="iconic-woothumbs-thumbnails__image-wrapper">
							...
							<img class="iconic-woothumbs-thumbnails__image" src="<?php echo $image['gallery_thumbnail_src']; ?>" srcset="<?php echo $image['gallery_thumbnail_srcset']; ?>" sizes="<?php echo $image['gallery_thumbnail_sizes']; ?>" title="<?php echo esc_attr( $image['title'] ); ?>" alt="<?php echo esc_attr( $image['alt'] ); ?>" width="<?php echo $image['gallery_thumbnail_src_w']; ?>" height="<?php echo $image['gallery_thumbnail_src_h']; ?>" nopin="nopin">
