...
class Iconic_WAS_Core_Settings {
	...
	public static function account_getting_started() {
		...
		<div class="iconic-notice iconic-notice--getting-started">
			<form action="" method="post" class="iconic-notice__dismiss">
				...
				<button title="<?php echo esc_attr( __( 'Dismiss', 'iconic-was' ) ); ?>">
			...
			<p><strong><?php _e( 'Is something not quite right?', 'iconic-was' ); ?></strong> <?php printf( __( 'Take a look at our
				<a href="%s" target="_blank">troubleshooting documentation</a>', 'iconic-was' ), self::get_docs_url( 'troubleshooting' ) ); ?>. <?php _e( 'There is a permanent link to the plugin documentation in the "Support" section below.', 'iconic-was' ); ?>
			</p>
		</div>
		<?php
	}
	...
	public static function output_getting_started_links() {
		...
		<ol>
			<?php foreach ( $links as $link ) { ?>
				<li>
					<a href="<?php echo esc_attr( self::get_docs_url() . $link['href'] ); ?>?utm_source=iconic-was&utm_medium=insideplugin" target="_blank"><?php echo $link['title']; ?></a>
				</li>
			<?php } ?>
		</ol>
	<?php }
	...
	public static function support_link() {
		return sprintf( '<a href="%s" class="button button-secondary" target="_blank">%s</a>', 'https://iconicwp.com/support?utm_source=iconic-was&utm_medium=insideplugin', __( 'Submit Ticket', 'iconic-was' ) );
	}
	...
	public static function documentation_link() {
		return sprintf( '<a href="%s" class="button button-secondary" target="_blank">%s</a>', self::get_docs_url( 'collection' ), __( 'Read Documentation', 'iconic-was' ) );
	}
	...
	public static function account_link() {
		return sprintf( '<a href="%s" class="button button-secondary" target="_blank">%s</a>', 'https://iconicwp.com/account?utm_source=iconic-was&utm_medium=insideplugin', __( 'Manage Your Account', 'iconic-was' ) );
	}
}