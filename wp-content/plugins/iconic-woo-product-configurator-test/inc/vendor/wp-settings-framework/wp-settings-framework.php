...
if ( ! class_exists( 'Iconic_PC_Settings_Framework' ) ) {
	/**
	 * Iconic_PC_Settings_Framework class
	 */
	class Iconic_PC_Settings_Framework {
		/**
		 * @access private
		 * @var array
		 */
		...
		/**
		 * Iconic_PC_Settings_Framework constructor.
		 *
