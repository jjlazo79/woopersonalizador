...
if ( class_exists( 'Iconic_CFFV_Core_Cross_Sells' ) ) {
	return;
}

/**
 * Iconic_CFFV_Core_Cross_Sells.
 *
 * @class    Iconic_CFFV_Core_Cross_Sells
 * @version  1.0.0
 * @category Class
 * @author   Iconic
 */
class Iconic_CFFV_Core_Cross_Sells {
	...
	/**
	 * Iconic_CFFV_Core_Cross_Sells constructor.
	 */
	...
	private static function get_plugins() {
		return array(
			'iconic-woo-show-single-variations'       => array(
				...
				'description' => __( 'Display individual product variations of a variable product in your product listings. Make it easy for your customers to view and filter product variations.', 'iconic-cffv' ),
			...
			'iconic-woothumbs'                        => array(
				...
				'description' => __( 'Enable zoom, sliders, video, fullscreen, multiple images per variation, and customisable layout options for your product imagery.', 'iconic-cffv' ),
			...
			'iconic-woo-delivery-slots'               => array(
				...
				'description' => __( 'Choose a delivery date and time for each order. Add a limit to the number of allowed reservations, restrict time slots to specific delivery methods, and so much more.', 'iconic-cffv' ),
			...
			'iconic-woo-linked-variations'            => array(
				...
				'description' => __( 'Link a group of WooCommerce products together by their attributes; a new way to handle product variations.', 'iconic-cffv' ),
			...
			'iconic-woo-product-configurator'         => array(
				...
				'description' => __( 'Use transparent image layers for your variable products, removing the need to create hundreds of final product variation images.', 'iconic-cffv' ),
			...
			'iconic-woo-quicktray'                    => array(
				...
				'description' => __( 'A modern take on quick view for WooCommerce; expand product details within your product listings for a convenient shopping experience.', 'iconic-cffv' ),
			...
			'iconic-woo-account-pages'                => array(
				...
				'description' => __( 'Add and manage pages in your WooCommerce "My Account" area using the native WordPress "Pages" functionality.', 'iconic-cffv' ),
			...
			'iconic-woo-quickview'                    => array(
				...
				'description' => __( 'Quickly view any product from the catalog, without reloading the page. Encourage sales with easy and efficient product browsing.', 'iconic-cffv' ),
			...
			'iconic-woo-attribute-swatches'           => array(
				...
				'description' => __( 'Bored of the standard dropdown fields when viewing a variable product? Turn them into colour, image, or text swatches!', 'iconic-cffv' ),
			...
			'iconic-woo-custom-fields-for-variations' => array(
				...
				'description' => __( 'Easily add custom fields to your product variations; the perfect way to display organised additional product data to your customers.', 'iconic-cffv' ),
			...
			'iconic-woo-bundled-products'             => array(
				...
				'description' => __( 'Bundle a selection of products on a single product page. It even works with variable products!', 'iconic-cffv' ),
	...
	public static function get_output() {
		...
		$utm = '?utm_source=iconic-cffv&utm_medium=dashboard&utm_campaign=cross-sell';
		...
		<div class="iconic-cross-sells-wrapper">
			<div class="iconic-cross-sells-columns iconic-cross-sells-columns--plugins">
				...
				<a href="https://iconicwp.com/products<?php echo esc_attr( $utm ); ?>" class="button-secondary"><?php _e( 'View All Iconic Plugins', 'iconic-cffv' ); ?></a>
			</div>
